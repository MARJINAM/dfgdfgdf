...
exports.run = async (client, message, args) => {
  if (!message.member.roles.has(`602821408216580097`) && !message.member.roles.has(`614156052815937546`) && message.author.id !== '602821408216580097') return message.channel.send(`⚠ **|** Üzgünüm, yetkin yok.`)
